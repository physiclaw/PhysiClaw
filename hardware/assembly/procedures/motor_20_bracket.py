...
UPPER belt plane (Motor A uses the 8 mm spacer for the lower plane), plus
the matching 4 mm longer ``BHCS_M5_LENGTH = 20`` screw that spans it.
...
class MO20Bracket(MO10Bracket):
    ...
    BHCS_M5_LENGTH = 20     # mm — 4 mm longer screw spans the 12 mm spacer
