...
2. Tick each listed line as you see it: tap its checkbox, the
   ...
   screen, and a tap there is REFUSED. The walk has ALREADY
   ...
   from view. If a listed line was on the first screen and is
   not now, scroll UP once. The checkbox is NEVER a listed
   element: box it off the screenshot, at the far left edge
   (x 0.02–0.14) at the line's height. A listed icon beside the
   title or price is a promo, never the checkbox. Match a line by product and
   spec, not word for word — the cart shows the listing title,
