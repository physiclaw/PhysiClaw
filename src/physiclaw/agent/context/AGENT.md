...
- **Write it down before you leave.** When you've extracted data on a page and the next step is on a different page — `scratchpad(content=...)` it before navigating away. (See CONVENTION § Scratchpad.)
