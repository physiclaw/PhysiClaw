...
One file per vendor — each subclasses `OpenAICompatibleProvider` from
`agent/provider/base.py` and declares its endpoint, model catalog, auth
lookup, and (optionally) a `THINKING_FORMAT` flag.
